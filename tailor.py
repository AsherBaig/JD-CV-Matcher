...
- cover_letter: full cover letter written as a senior recruiter would write it. Structure: (1) opening — who the candidate is and why this specific role, (2) what they bring — 2-3 strongest relevant skills/achievements from their CV matched to the JD, (3) transition framing — how their C#/.NET background is an asset not a liability for this role, (4) closing — availability as Werkstudent/Praktikum, enthusiasm, call to action. Professional German market tone. No fluff. Ready to send as-is.
